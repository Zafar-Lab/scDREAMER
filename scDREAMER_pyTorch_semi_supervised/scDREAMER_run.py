...
parser.add_argument("--z_dim", type = int, default = 10, help = "dimension for latent space representation")
...
params.cell_type = None #cell_type_key_dic[params.name]
...
adata_ = read_data(data_path, params.batch, params.cell_type, params.name)

z = scdreamer_net.process(adata_) # de_feat
adata_.obsm['final_embeddings'] = pd.DataFrame(z,index = adata_.obs_names).to_numpy()
