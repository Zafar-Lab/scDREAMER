...
class scDREAMER_Train:
    ...
    def __init__(self, adata, params):
        ...
        self.kl_scale = 0.001 # 0.001 earlier...0.01 tried so far
    ...
    def train_batch_classifier(self, epoch):
    ...
    def train_discriminator(self, epoch):
        ...
        #if (epoch >= 50):
        print ("Epoch :", epoch, "b loss:", bhattachryya_loss.item())
    ...
    def train_network(self):
        ...
        for epoch in range(self.epochs):
            ...
            for ep in range(1):
                self.train_batch_classifier(epoch)
