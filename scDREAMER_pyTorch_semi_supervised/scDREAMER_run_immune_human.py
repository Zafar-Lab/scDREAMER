...
parser.add_argument("--name", type = str, default = "Immune_Human", help = "dataset name") #Pancreas
...
data_path = "../Human_Retina/Human_Retina.h5ad"
data_path = "../Immune/Immune_Human_NA_0.5.h5ad" #Immune_Human_NA_0.5, Immune_ALL_human
