...
def kBET_single(
    ...
    try:
        ...
        return ro.r("batch.estimate$summary$kBET.observed")[0],ro.r("batch.estimate$stats$kBET.observed")
...
def kBET(
    ...
    kBET_scores = {'cluster': [], 'kBET': [], 'kBET_all':[]}
    ...
    for clus in adata_tmp.obs[label_key].unique():
        ...
        if np.logical_or(adata_sub.n_obs < 10,
            ...
            if n_comp > 1:
                ...
                if len(idx_nonan) / len(labs) >= 0.75:
                    ...
                    #call kBET
                    score, obsered_values = kBET_single(
                        matrix=matrix,
        ...
        kBET_scores['kBET_all'].append(obsered_values)
