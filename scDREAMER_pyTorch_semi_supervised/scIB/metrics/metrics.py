...
def metrics(
    ...
    if kBET_:
        ...
        try:
            ...
            kbet_all = kbet_results['kBET_all']
    ...
    if lisi_graph_:
        ...
        ilisi_raw, clisi_raw ,ilisi_all,clisi_all= lisi_graph(
            adata_int,
            batch_key=batch_key,
            label_key=label_key,
            type_=type_,
    ...
    return pd.DataFrame.from_dict(results, orient='index'), ilisi_all,clisi_all,kbet_all
