...
def lisi(
    ...
    if scale:
        ...
        ilisi_score, clisi_score = scale_lisi(ilisi_score, clisi_score, nbatches,nlabs)
...
def lisi_graph(
    ...
    ilisi_score_all, clisi_score_all = ilisi_score, clisi_score
    # iLISI: nbatches good, 1 bad
    ...
    return ilisi_score, clisi_score, ilisi_score_all, clisi_score_all 
